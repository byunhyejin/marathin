...
# 다음 달 마라톤 대회까지 남은 시간 계산
def update_countdown():
    next_month = datetime(datetime.today().year, datetime.today().month + 1, 15)
    now = datetime.now()
    difference = next_month - now
...
st.subheader("다음 마라톤 대회까지 남은 시간")
st.write(update_countdown())

# 지도 데이터
st.subheader("마라톤 코스")
map_data = pd.DataFrame({
    'lat': [37.5665, 37.5707, 37.5729, 37.5717, 37.5690, 37.5665],
    'lon': [126.9780, 126.9762, 126.9810, 126.9856, 126.9871, 126.9780]
})
